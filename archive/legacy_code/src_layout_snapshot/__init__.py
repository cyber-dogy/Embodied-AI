...
from .common.runtime import CKPT_ROOT, DATA_ROOT, PROJECT_ROOT, get_device, set_device, set_seeds


def train_experiment(*args, **kwargs):
    from .train.runner import train_experiment as _train_experiment

    return _train_experiment(*args, **kwargs)


def load_model_for_eval(*args, **kwargs):
    from .train.eval import load_model_for_eval as _load_model_for_eval

    return _load_model_for_eval(*args, **kwargs)


def run_success_rate_eval(*args, **kwargs):
    from .train.eval import run_success_rate_eval as _run_success_rate_eval
