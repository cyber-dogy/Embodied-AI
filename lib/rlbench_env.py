...
from .o3d_utils import make_pcd, merge_pcds
from .se3_utils import rot6d_to_quat_np, pfp_to_pose_np
from .task_text import choose_instruction
...
class RLBenchEnv(BaseEnv):
    ...
    def __init__(
        ...
        if self.vis:
            from .visualization import RerunViewer
