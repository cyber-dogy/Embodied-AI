...
from research import finalize_mdit_autoresearch_trial, run_mdit_autoresearch_trial, train_mdit_autoresearch_trial
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=None,
        help="Enable wandb for this trial. MDIT line defaults to enabled unless --no-enable-wandb is set.",
    )
    parser.add_argument(
        "--audit-timeout-sec",
        type=int,
