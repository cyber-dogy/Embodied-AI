...
from mdit.train.eval import load_model_for_eval
...
def build_argparser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Record simulator rollout videos for one faithful MDIT checkpoint."
    )
    ...
    try:
        for episode_idx in range(int(args.episodes)):
            ...
            if bool(args.show_progress):
                ...
                print(
                    f"mdit video rollout: episode={episode_idx} success={success} "
