#!/usr/bin/env python3
#评估代码
/home/gjw/miniconda3/envs/pfp_env/bin/python -u \
  /home/gjw/MyProjects/autodl_unplug_charger_transformer_fm/scripts/eval_checkpoint.py \
  --ckpt-path /home/gjw/MyProjects/autodl_unplug_charger_transformer_fm/ckpt_obs4/epochs/epoch_1300.pt \
  --episodes 100 \
  --max-steps 200 \
  --seed 1234 \
  --headless \
...
def main() -> int:
    ...
    from lib.common import set_seeds
    ...
    eval_seed = int(cfg_dict.get("seed", 1234) if args.seed is None else args.seed)
