...
from ..data import RobotDatasetPcd
from ..models import DiTTrajectoryBackbone, PointNetObsTokenEncoder
from ..utils.common import get_device, set_device


def build_dataset(path: str, cfg: ExperimentConfig) -> RobotDatasetPcd:
...
def build_policy(cfg: ExperimentConfig, strategy: str):
    ...
    if strategy == "fm":
        from ..policies import FMPolicyConfig, FMTransformerPolicy
        ...
        from ..policies import DiffusionPolicyConfig, DiffusionTransformerPolicy
