...
from ..data.registry import build_dataset as build_dataset_from_registry
from ..model.registry import build_backbone as build_backbone_from_registry
from ..model.registry import build_obs_encoder as build_obs_encoder_from_registry
from ..policy.registry import build_policy as build_policy_from_registry
